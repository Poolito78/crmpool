...
const demoClients: Client[] = [
  { id: '1', nom: 'Martin Dupont', email: 'martin@entreprise.fr', telephone: '06 12 34 56 78', adresse: '12 Rue de la Paix', ville: 'Paris', codePostal: '75002', societe: 'Dupont SARL', dateCreation: '2024-01-15' },
  { id: '2', nom: 'Sophie Laurent', email: 'sophie@laurent.com', telephone: '06 98 76 54 32', adresse: '45 Avenue des Champs', ville: 'Lyon', codePostal: '69003', societe: 'Laurent & Co', dateCreation: '2024-02-20' },
  { id: '3', nom: 'Pierre Bernard', email: 'p.bernard@mail.fr', telephone: '07 11 22 33 44', adresse: '8 Boulevard Haussmann', ville: 'Marseille', codePostal: '13001', dateCreation: '2024-03-10' },
];
...
const demoProduits: Produit[] = [
  { id: '1', reference: 'PRD-001', nom: 'Câble électrique 2.5mm²', description: 'Câble cuivre souple', prixHT: 1.50, tva: 20, unite: 'm', stock: 500, stockMin: 100, fournisseurId: '2', categorie: 'Électricité', dateCreation: '2024-01-10' },
  { id: '2', reference: 'PRD-002', nom: 'Interrupteur double', description: 'Interrupteur va-et-vient', prixHT: 12.90, tva: 20, unite: 'pièce', stock: 45, stockMin: 10, fournisseurId: '2', categorie: 'Électricité', dateCreation: '2024-01-10' },
  { id: '3', reference: 'PRD-003', nom: 'Tube PVC 100mm', description: 'Tube d\'évacuation', prixHT: 8.50, tva: 20, unite: 'm', stock: 80, stockMin: 20, fournisseurId: '1', categorie: 'Plomberie', dateCreation: '2024-02-01' },
  { id: '4', reference: 'PRD-004', nom: 'Robinet mitigeur', description: 'Mitigeur cuisine chromé', prixHT: 45.00, tva: 20, unite: 'pièce', stock: 8, stockMin: 5, fournisseurId: '1', categorie: 'Plomberie', dateCreation: '2024-02-15' },
  { id: '5', reference: 'PRD-005', nom: 'Peinture blanche 10L', description: 'Peinture acrylique mate', prixHT: 35.00, tva: 20, unite: 'pot', stock: 3, stockMin: 5, fournisseurId: '1', categorie: 'Peinture', dateCreation: '2024-03-01' },
];
